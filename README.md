...
```
Започваме програмата с проверката на средната възраст на учениците и дали има някой outliner-и, ученици който може би са повтаряли правим проверката На outliner-ите и построяване boxplot
